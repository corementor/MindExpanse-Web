...
// // Update your VerifyResponse interface
...
//     setError(null);
//     try {
//       // We'll request a 2x2 array since we need pairs of numbers (4 questions total)
//       const response = await fetch(
//         `http://localhost:8080/api/math/addition/generateArray?rows=2&cols=2&min=1000&max=9999`,
//         {
//           headers: {
...
//         prev.map((q, idx) => ({
//           ...q,
//           isCorrect: data.results[idx].includes("Correct"),
//           carryValidation: {
...
//   // Update the renderQuestion function to show carry validation
...
//                   `${pos}Correct` as keyof typeof question.carryValidation
//                 ] ?? true;
...
//                   type="text"
//                   maxLength={1}
//                   className={`w-12 h-12 border text-2xl font-bold text-center ${
//                     showResults
//                       ? isCorrect
//                         ? "bg-green-100 border-green-500"
//                         : "bg-red-100 border-red-500"
//                       : "bg-green-50 border-gray-400"
//                   }`}
//                   value={
...
//                   `${question.userAnswer.tenThousands || "0"}${
//                     question.userAnswer.thousands
//                   }${question.userAnswer.hundreds}${question.userAnswer.tens}${
//                     question.userAnswer.ones
//                   }` || "0"
//                 );
...
//                     "ones",
//                   ].indexOf(pos);
//                   const correctDigit = String(correctAnswer).padStart(5, "0")[
//                     digitPos
//                   ];
//                   return (
//                     question.userAnswer[
//                       pos as keyof typeof question.userAnswer
//                     ] === correctDigit
//                   );
//                 })();
